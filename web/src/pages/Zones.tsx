...
export default function Zones() {
  ...
  return (
    <div className="h-full w-full bg-[#F3F1ED] flex flex-col lg:flex-row overflow-hidden">
      {/* Workers Side Panel */}
      <div className={`${showPanel ? 'w-full lg:w-80 xl:w-96' : 'w-0'} bg-[#F3F1ED] border-l border-[#7895B2]/20 flex flex-col transition-all duration-300 overflow-hidden order-2 lg:order-1`}>
        {/* Panel Header */}
        <div className="p-4 border-b border-[#7895B2]/10 bg-[#7895B2]/5">
          <div className="flex items-center justify-between mb-2">
            <button
              ...
              disabled={refreshing}
              className={`p-2 rounded-lg hover:bg-[#7895B2]/10 transition-colors text-[#6B7280] ${refreshing ? 'animate-spin' : ''}`}
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            <div className="text-center p-2 bg-white rounded-lg border border-[#7895B2]/10">
          ...
          {workers.length === 0 ? (
            ...
            workers.map(w => (
              <div
                ...
                className={`bg-white hover:bg-[#7895B2]/5 p-3 rounded-xl border transition-all cursor-pointer ${selectedId === w.id ? 'border-[#7895B2] shadow-md' : 'border-[#7895B2]/10'}`}
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex flex-col items-start gap-1">
                    ...
                    {w.batteryLevel !== undefined && (
                      <div className="flex items-center gap-1.5 bg-[#F3F1ED] px-2 py-0.5 rounded-lg border border-[#7895B2]/10 mt-1">
                        <span className="text-[10px] font-bold text-[#6B7280] font-sans">{w.batteryLevel}%</span>
                ...
                <div className="mt-2 flex items-center justify-between border-t border-[#7895B2]/5 pt-2">
      ...
      <div className="flex-1 relative order-1 lg:order-2 min-h-[500px]">
        ...
        <button
          ...
          className="absolute bottom-4 right-4 z-[1000] lg:hidden bg-white rounded-full p-3 shadow-lg border border-[#7895B2]/20"
        >
          <MapPin size={20} className="text-[#7895B2]" />
        </button>
      </div>
    </div>
  );
